...
@push('modal')
    <div id="modal-search-global"
        ...
        <div
            ...
            <div class="flex flex-col w-full border rounded-md shadow-sm pointer-events-auto bg-background">
                <div class="relative flex items-center px-3 border-b">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" class="mr-2 opacity-50 lucide lucide-search size-4 shrink-0">
                        <circle cx="11" cy="11" r="8"></circle>
                        <path d="m21 21-4.3-4.3"></path>
                    </svg>
                    <input
                        class="flex w-full py-3 text-sm bg-transparent rounded-md outline-none placeholder:text-foreground-muted h-11 disabled:cursor-not-allowed disabled:opacity-50"
                ...
                <div class="max-h-[300px] h-full overflow-y-auto">
                    <div class="px-2 py-1 overflow-hidden text-foreground" role="presentation" data-value="MENU">
                        ...
                        <div role="group">
                            <a href="#"
                                class="relative flex items-center px-2 py-3 text-sm rounded-sm outline-none cursor-default aria-selected:bg-accent aria-selected:text-accent-foreground hover:bg-accent hover:text-accent-foreground"
                                role="option" data-disabled="false" data-selected="true"
                                data-value="Dashboard"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                    class="mr-2 lucide lucide-layout-panel-left size-5">
                            ...
                            <a href="#"
                                class="relative flex items-center px-2 py-3 text-sm rounded-sm outline-none cursor-default aria-selected:bg-accent aria-selected:text-accent-foreground hover:bg-accent hover:text-accent-foreground"
                                role="option" data-disabled="false" data-selected="false" data-value="Billing"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="mr-2 lucide lucide-credit-card size-5">
                                    <rect width="20" height="14" x="2" y="5" rx="2"></rect>
                                    <line x1="2" x2="22" y1="10" y2="10"></line>
                                </svg>Billing</a>
                            <a href="#"
                                class="relative flex items-center px-2 py-3 text-sm rounded-sm outline-none cursor-default aria-selected:bg-accent aria-selected:text-accent-foreground hover:bg-accent hover:text-accent-foreground"
                                role="option" data-disabled="false" data-selected="false"
                                data-value="Charts"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <a href="#"
                                class="relative flex items-center px-2 py-3 text-sm rounded-sm outline-none cursor-default aria-selected:bg-accent aria-selected:text-accent-foreground hover:bg-accent hover:text-accent-foreground"
                                role="option" data-disabled="false" data-selected="false"
                                data-value="User Posts"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="px-2 py-1 overflow-hidden text-foreground" role="presentation"
                        data-value="OPTIONS">
                        ...
                        <div role="group">
                            <a href="#"
                                class="relative flex items-center px-2 py-3 text-sm rounded-sm outline-none cursor-default aria-selected:bg-accent aria-selected:text-accent-foreground hover:bg-accent hover:text-accent-foreground"
                                role="option" data-disabled="false" data-selected="false"
                                data-value="Settings"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <a href="#"
                                class="relative flex items-center px-2 py-3 text-sm rounded-sm outline-none cursor-default aria-selected:bg-accent aria-selected:text-accent-foreground hover:bg-accent hover:text-accent-foreground"
                                role="option" data-disabled="false" data-selected="false"
                                data-value="Homepage"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <a href="#"
                                class="relative flex items-center px-2 py-3 text-sm rounded-sm outline-none cursor-default aria-selected:bg-accent aria-selected:text-accent-foreground hover:bg-accent hover:text-accent-foreground"
                                role="option" data-disabled="false" data-selected="false"
                                data-value="Documentation"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <a href="#"
                                class="relative flex items-center px-2 py-3 text-sm rounded-sm outline-none cursor-default aria-selected:bg-accent aria-selected:text-accent-foreground hover:bg-accent hover:text-accent-foreground"
                                role="option" data-disabled="false" data-selected="false"
                                data-value="Support"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
